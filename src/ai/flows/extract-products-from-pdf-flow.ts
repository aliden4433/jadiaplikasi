...
const ProductSchema = z.object({
  name: z.string().describe('The complete and unabbreviated name of the product.'),
...
const extractProductsPrompt = ai.definePrompt({
  ...
  - **Product Name**: The **complete and unabbreviated name** of the product as it appears in the document. Do not shorten or truncate it.
  ...
  **CRITICAL INSTRUCTIONS:**
  1.  **Capture Full Product Name**: It is essential to capture the entire, complete product name. Do not abbreviate or leave out any details from the name.
